package top.leix.restful.controller;
...
public class CityController {
    ...
    public List<Region> getRegions(@RequestParam(value = "page") int page, @RequestParam(value = "size") int size) {

        return cityService.findAllRegions();
        //return this.cityService.findByState("CA");
    }
